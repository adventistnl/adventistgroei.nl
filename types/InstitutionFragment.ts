...
export interface InstitutionFragment_users_contact {
  __typename: "Contact";
  id: string;
  name: string | null;
  phone: string | null;
...
export interface InstitutionFragment_users {
  ...
  institution_id: string;
  contact: InstitutionFragment_users_contact | null;
...
export interface InstitutionFragment_churches_leader {
  __typename: "User";
  id: string;
  name: string;
  email: string;
...
export interface InstitutionFragment_churches_departments_users_contact {
  __typename: "Contact";
  id: string;
  name: string | null;
  phone: string | null;
...
export interface InstitutionFragment_churches_departments_users_institution {
  __typename: "Institution";
  id: string;
  name: string;
}

export interface InstitutionFragment_churches_departments_users_church {
  __typename: "Church";
  id: string;
  name: string;
}
...
export interface InstitutionFragment_churches_departments_users_user_roles {
  __typename: "UserRole";
  id: string;
  role: InstitutionFragment_churches_departments_users_user_roles_role;
}
...
export interface InstitutionFragment_churches_departments_users {
  ...
  contact_id: string | null;
  institution_id: string;
  contact: InstitutionFragment_churches_departments_users_contact | null;
  institution: InstitutionFragment_churches_departments_users_institution;
  church: InstitutionFragment_churches_departments_users_church | null;
  user_roles: InstitutionFragment_churches_departments_users_user_roles[] | null;
}
...
export interface InstitutionFragment_churches_departments {
  ...
  annual_budgets: InstitutionFragment_churches_departments_annual_budgets[];
...
export interface InstitutionFragment_churches_users_contact {
  __typename: "Contact";
  id: string;
  name: string | null;
  phone: string | null;
...
export interface InstitutionFragment_churches_users_institution {
  __typename: "Institution";
  id: string;
  name: string;
}

export interface InstitutionFragment_churches_users_church {
  __typename: "Church";
  id: string;
  name: string;
}

export interface InstitutionFragment_churches_users_user_roles_role {
  __typename: "Role";
  id: string;
  name: string;
  key_code: string;
...
export interface InstitutionFragment_churches_users_user_roles {
  __typename: "UserRole";
  id: string;
  role: InstitutionFragment_churches_users_user_roles_role;
}
...
export interface InstitutionFragment_churches_users {
  ...
  contact_id: string | null;
  institution_id: string;
  contact: InstitutionFragment_churches_users_contact | null;
  institution: InstitutionFragment_churches_users_institution;
  church: InstitutionFragment_churches_users_church | null;
  user_roles: InstitutionFragment_churches_users_user_roles[] | null;
}

export interface InstitutionFragment_churches_subsidy_requests {
  __typename: "SubsidyRequest";
  id: string;
  description: string;
  total_budget: any;
...
export interface InstitutionFragment_churches_projects {
  __typename: "Project";
  id: string;
  department_id: string;
  title: string;
...
export interface InstitutionFragment_departments_users_contact {
  __typename: "Contact";
  id: string;
  name: string | null;
  phone: string | null;
...
export interface InstitutionFragment_departments_users_institution {
  __typename: "Institution";
  id: string;
  name: string;
}

export interface InstitutionFragment_departments_users_church {
  __typename: "Church";
  id: string;
  name: string;
}
...
export interface InstitutionFragment_departments_users_user_roles {
  __typename: "UserRole";
  id: string;
  role: InstitutionFragment_departments_users_user_roles_role;
}
...
export interface InstitutionFragment_departments_users {
  ...
  contact_id: string | null;
  institution_id: string;
  contact: InstitutionFragment_departments_users_contact | null;
  institution: InstitutionFragment_departments_users_institution;
  church: InstitutionFragment_departments_users_church | null;
  user_roles: InstitutionFragment_departments_users_user_roles[] | null;
}
...
export interface InstitutionFragment_departments {
  ...
  annual_budgets: InstitutionFragment_departments_annual_budgets[];
...
export interface InstitutionFragment_churchesActivityData {
...
export interface InstitutionFragment_institutionChartsData_usersByRole {
...
export interface InstitutionFragment_institutionChartsData_churchesByRegion {
...
export interface InstitutionFragment {
  ...
  churchesActivityData: InstitutionFragment_churchesActivityData[];
  institutionChartsData: InstitutionFragment_institutionChartsData;
}
