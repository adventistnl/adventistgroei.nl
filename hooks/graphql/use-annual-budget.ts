...
export function useRequestRevisionAnnualBudgetMutation(options?: useMutation.Options<RequestRevisionAnnualBudget, RequestRevisionAnnualBudgetVariables>): useMutation.ResultTuple<RequestRevisionAnnualBudget, RequestRevisionAnnualBudgetVariables> {
