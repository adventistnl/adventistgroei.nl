...
export function RoleSelector({ 
  ...
  const getTagStyle = (minWidth: string, height: string) => {
    if (layout === "grid") {
      return height === "auto" ? "min-h-[60px]" : "h-[60px]"
    }
    return `flex-1 min-w-[${minWidth}] ${height === "auto" ? "min-h-[60px]" : "h-[60px]"}`
  }
