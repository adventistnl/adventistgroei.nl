...
import { CREATE_DEPARTMENT_MUTATION, UPDATE_DEPARTMENT_MUTATION, DELETE_DEPARTMENT_MUTATION } from "@/graphql/mutations/DEPARTMENT_MUTATIONS";
...
export function useUpdateDepartmentMutation(options?: useMutation.Options<any, any>) {
  return useMutation(UPDATE_DEPARTMENT_MUTATION, options);
}

export function useDeleteDepartmentMutation(options?: useMutation.Options<any, any>) {
