...
export default function DashboardPage() {
  ...
  // Process institutions data with complete information
    ...
    <AppLayout>
      ...
      {/* Date & Time Display */}
        ...
        {currentInstitutionData && (
          <div>
            <SectionHeader
              title={currentLanguage === 'pt' ? 'Visão Geral do Orçamento' : currentLanguage === 'nl' ? 'Budgetoverzicht' : 'Budget Overview'}
              icon={DollarSign}
              description={currentLanguage === 'pt' ? `Distribuição e utilização do orçamento ${selectedYear}` : currentLanguage === 'nl' ? `Budgetverdeling en gebruik ${selectedYear}` : `Budget distribution and utilization ${selectedYear}`}
            />
            ...
            <div className="space-y-6">
              ...
              {spendingOverTimeData.length > 0 && (
                <SpendingOverTimeChart
                  data={spendingOverTimeData as any}
                  year={selectedYear}
                />
              )}
            </div>
        ...
        {/* Section 5: User Growth & Distribution */}
        <div>
          <SectionHeader
