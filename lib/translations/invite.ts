export const inviteTranslations = {
  en: {
    ...
    roleExtraFields: {
      churchLabel: "Church",
      churchDepartmentLabel: "Church Department",
      institutionLabel: "Institution",
      institutionDepartmentLabel: "Institution Department",
  ...
  nl: {
    ...
    roleExtraFields: {
      churchLabel: "Kerk",
      churchDepartmentLabel: "Kerkafdeling",
      institutionLabel: "Instelling",
      institutionDepartmentLabel: "Instellingsafdeling",
      selectChurch: "Selecteer een kerk",
      searchChurch: "Kerk zoeken...",
      noChurchFound: "Geen kerk gevonden.",
      selectInstitution: "Selecteer een instelling",
      searchInstitution: "Instelling zoeken...",
      noInstitutionFound: "Geen instelling gevonden.",
      selectDepartment: "Selecteer een afdeling",
      searchDepartment: "Afdeling zoeken...",
  ...
  pt: {
    ...
    roleExtraFields: {
      churchLabel: "Igreja",
      churchDepartmentLabel: "Departamento da Igreja",
      institutionLabel: "Instituição",
      institutionDepartmentLabel: "Departamento da Instituição",
      selectChurch: "Selecione a igreja",
      searchChurch: "Buscar igreja...",
      noChurchFound: "Nenhuma igreja encontrada.",
