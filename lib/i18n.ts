...
const resources = {
    ...
    translation: {
      ...
      activities: {
        ...
        user_selector: {
          ...
          minimum_required: "At least one assignee must be selected"
        },
        documents: {
      ...
      notifications: {
        ...
        status_change_message: "{{actor}} changed the status to \"{{status}}\"",
        subsidy_status_change_title: "Subsidy update in {{projectTitle}}",
        subsidy_status_change_message: "Subsidy \"{{subsidy}}\" changed to \"{{status}}\"",
        new_message_title: "New message in {{projectTitle}}",
        new_message: "{{actor}}: {{comment}}",
        budget_updated_title: "Budget updated in {{projectTitle}}",
        budget_updated_message: "{{actor}} updated the project budget",
        deadline_updated_title: "Deadline updated in {{projectTitle}}",
        deadline_updated_message: "{{actor}} updated the project deadline",
        owner_changed_title: "Owner changed in {{projectTitle}}",
        owner_changed_message: "{{actor}} updated the project owner",
        co_owner_updated_title: "Co-owner updated in {{projectTitle}}",
        co_owner_updated_message: "{{actor}} updated the project co-owner",
        adjustment_needed_title: "Adjustment needed in {{projectTitle}}",
        adjustment_needed_message: "{{actor}} requested an adjustment",
        project_created_title: "Project created",
        project_created_message: "{{actor}} created the project \"{{projectTitle}}\"",
        project_deleted_title: "Project deleted",
        project_deleted_message: "{{actor}} deleted the project \"{{projectTitle}}\"",
        activity_created_title: "New activity in {{projectTitle}}",
        activity_created_message: "{{actor}} created activity \"{{activityName}}\"",
        activity_updated_title: "Activity updated in {{projectTitle}}",
        activity_updated_message: "{{actor}} updated an activity",
        activity_deleted_title: "Activity removed in {{projectTitle}}",
        activity_deleted_message: "{{actor}} deleted an activity",
        activity_deleted_named_message: "{{actor}} deleted the activity: \"{{activityName}}\"",
        subsidy_created_title: "New subsidy in {{projectTitle}}",
        subsidy_created_message: "{{actor}} submitted a subsidy request",
        subsidy_created_named_message: "{{actor}} submitted a subsidy request: \"{{subsidy}}\"",
        subsidy_updated_title: "Subsidy updated in {{projectTitle}}",
        subsidy_updated_message: "{{actor}} updated a subsidy request",
        subsidy_approved_title: "Subsidy approved in {{projectTitle}}",
        subsidy_approved_message: "A subsidy request was approved",
        subsidy_rejected_title: "Subsidy rejected in {{projectTitle}}",
        subsidy_rejected_message: "A subsidy request was rejected",
        subsidy_deleted_title: "Subsidy removed in {{projectTitle}}",
        subsidy_deleted_message: "{{actor}} deleted a subsidy request",
        subsidy_document_updated_title: "New document in {{projectTitle}}",
        subsidy_document_updated_message: "{{actor}} uploaded a document to a subsidy",
        subsidy_document_validated_title: "Document validated in {{projectTitle}}",
        subsidy_document_validated_message: "A document has been validated by finance",
        subsidy_document_rejected_title: "Document rejected in {{projectTitle}}",
        subsidy_document_rejected_message: "A document has been rejected by finance",
        annual_budget_created_title: "New Annual Budget",
        annual_budget_created_message: "A new annual budget has been created for your entity",
        annual_budget_closed_title: "Annual Budget Closed",
        annual_budget_closed_message: "An annual budget for your entity has been closed",
        subsidy_deleted_named_message: "{{actor}} deleted a subsidy request: \"{{subsidy}}\"",
        update_title: "Update in {{projectTitle}}",
        update_message: "{{actor}} made a change to the project",
        assignment_request_received_title: "New preaching request at {{churchName}}",
        assignment_request_received_message: "{{preacherName}} requested to preach at {{churchName}}.",
        assignment_invite_received_title: "You've been invited to preach",
        assignment_invite_received_message: "You've been invited to preach at {{churchName}} on {{date}}.",
        assignment_invite_custom_title: "You've been invited to preach",
        assignment_request_accepted_title: "Request accepted",
        assignment_request_accepted_message: "Your assignment request for {{churchName}} on {{date}} was accepted.",
        assignment_request_declined_title: "Request declined",
        assignment_request_declined_message: "Your assignment request for {{churchName}} on {{date}} was declined.",
        monthly_close_reminder_open_slots_title: "Open slots before monthly close",
        monthly_close_reminder_open_slots_message: "{{churchName}} still has {{count}} open slot(s) for {{month}} before the schedule locks.",
        monthly_close_reminder_incomplete_availability_title: "Availability not set for {{month}}",
        monthly_close_reminder_incomplete_availability_message: "Please set your availability for {{month}} before the schedule locks.",
        monthly_close_auto_confirmed_title: "Assignment auto-confirmed",
        monthly_close_auto_confirmed_message: "Your pending assignment at {{churchName}} on {{date}} was automatically confirmed at monthly close.",
        custom_text: "{{text}}",
      ...
      annual_budget: {
        ...
        export: {
          ...
          section_department_budgets: "DEPARTMENT BUDGETS",
          section_budget_distribution: "BUDGET DISTRIBUTION",
          section_department_spending: "DEPARTMENT SPENDING",
          institution: "Institution",
          year: "Year",
          total_budget: "Total Budget",
          ...
          completed: "Completed",
          missing: "Missing",
          success: "Annual budget exported successfully",
    ...
    translation: {
      ...
      activities: {
        ...
        user_selector: {
          ...
          minimum_required: "Er moet ten minste één verantwoordelijke worden geselecteerd"
        },
        documents: {
      ...
      notifications: {
        status_change_title: "Update in {{projectTitle}}",
        status_change_message: "{{actor}} heeft de status gewijzigd naar \"{{status}}\"",
        subsidy_status_change_title: "Subsidie-update in {{projectTitle}}",
        subsidy_status_change_message: "Subsidie \"{{subsidy}}\" gewijzigd naar \"{{status}}\"",
        new_message_title: "Nieuw bericht in {{projectTitle}}",
        new_message: "{{actor}}: {{comment}}",
        budget_updated_title: "Budget bijgewerkt in {{projectTitle}}",
        budget_updated_message: "{{actor}} heeft het projectbudget bijgewerkt",
        deadline_updated_title: "Deadline bijgewerkt in {{projectTitle}}",
        deadline_updated_message: "{{actor}} heeft de projectdeadline bijgewerkt",
        owner_changed_title: "Eigenaar gewijzigd in {{projectTitle}}",
        owner_changed_message: "{{actor}} heeft de projecteigenaar bijgewerkt",
        co_owner_updated_title: "Mede-eigenaar bijgewerkt in {{projectTitle}}",
        co_owner_updated_message: "{{actor}} heeft de mede-eigenaar bijgewerkt",
        adjustment_needed_title: "Aanpassing vereist in {{projectTitle}}",
        adjustment_needed_message: "{{actor}} heeft een aanpassing aangevraagd",
        project_created_title: "Project aangemaakt",
        project_created_message: "{{actor}} heeft het project \"{{projectTitle}}\" aangemaakt",
        project_deleted_title: "Project verwijderd",
        project_deleted_message: "{{actor}} heeft het project \"{{projectTitle}}\" verwijderd",
        activity_created_title: "Nieuwe activiteit in {{projectTitle}}",
        activity_created_message: "{{actor}} heeft activiteit \"{{activityName}}\" aangemaakt",
        activity_updated_title: "Activiteit bijgewerkt in {{projectTitle}}",
        activity_updated_message: "{{actor}} heeft een activiteit bijgewerkt",
        activity_deleted_title: "Activiteit verwijderd in {{projectTitle}}",
        activity_deleted_message: "{{actor}} heeft een activiteit verwijderd",
        activity_deleted_named_message: "{{actor}} heeft de activiteit verwijderd: \"{{activityName}}\"",
        subsidy_created_title: "Nieuwe subsidie in {{projectTitle}}",
        subsidy_created_message: "{{actor}} heeft een subsidieaanvraag ingediend",
        subsidy_created_named_message: "{{actor}} heeft een subsidieaanvraag ingediend: \"{{subsidy}}\"",
        subsidy_updated_title: "Subsidie bijgewerkt in {{projectTitle}}",
        subsidy_updated_message: "{{actor}} heeft een subsidieaanvraag bijgewerkt",
        subsidy_approved_title: "Subsidie goedgekeurd in {{projectTitle}}",
        subsidy_approved_message: "Een subsidieaanvraag is goedgekeurd",
        subsidy_rejected_title: "Subsidie afgewezen in {{projectTitle}}",
        subsidy_rejected_message: "Een subsidieaanvraag is afgewezen",
        subsidy_deleted_title: "Subsidie verwijderd in {{projectTitle}}",
        subsidy_deleted_message: "{{actor}} heeft een subsidieaanvraag verwijderd",
        subsidy_document_updated_title: "Nieuw document in {{projectTitle}}",
        subsidy_document_updated_message: "{{actor}} heeft een document geüpload naar een subsidie",
        subsidy_document_validated_title: "Document goedgekeurd in {{projectTitle}}",
        subsidy_document_validated_message: "Een document is goedgekeurd door financiën",
        subsidy_document_rejected_title: "Document afgewezen in {{projectTitle}}",
        subsidy_document_rejected_message: "Een document is afgewezen door financiën",
        annual_budget_created_title: "Nieuw Jaarlijks Budget",
        annual_budget_created_message: "Er is een nieuw jaarlijks budget aangemaakt voor uw entiteit",
        annual_budget_closed_title: "Jaarlijks Budget Gesloten",
        annual_budget_closed_message: "Een jaarlijks budget voor uw entiteit is gesloten",
        subsidy_deleted_named_message: "{{actor}} heeft een subsidieaanvraag verwijderd: \"{{subsidy}}\"",
        update_title: "Update in {{projectTitle}}",
        update_message: "{{actor}} heeft een wijziging aangebracht in het project",
        assignment_request_received_title: "Nieuw preekverzoek bij {{churchName}}",
        assignment_request_received_message: "{{preacherName}} heeft gevraagd om te preken bij {{churchName}}.",
        assignment_invite_received_title: "Je bent uitgenodigd om te preken",
        assignment_invite_received_message: "Je bent uitgenodigd om te preken bij {{churchName}} op {{date}}.",
        assignment_invite_custom_title: "Je bent uitgenodigd om te preken",
        assignment_request_accepted_title: "Verzoek geaccepteerd",
        assignment_request_accepted_message: "Je preekverzoek voor {{churchName}} op {{date}} is geaccepteerd.",
        assignment_request_declined_title: "Verzoek afgewezen",
        assignment_request_declined_message: "Je preekverzoek voor {{churchName}} op {{date}} is afgewezen.",
        monthly_close_reminder_open_slots_title: "Openstaande plekken vóór maandelijkse afsluiting",
        monthly_close_reminder_open_slots_message: "{{churchName}} heeft nog {{count}} openstaande plek(ken) voor {{month}} voordat het schema wordt vergrendeld.",
        monthly_close_reminder_incomplete_availability_title: "Beschikbaarheid niet ingesteld voor {{month}}",
        monthly_close_reminder_incomplete_availability_message: "Stel je beschikbaarheid in voor {{month}} voordat het schema wordt vergrendeld.",
        monthly_close_auto_confirmed_title: "Toewijzing automatisch bevestigd",
        monthly_close_auto_confirmed_message: "Je openstaande toewijzing bij {{churchName}} op {{date}} is automatisch bevestigd bij de maandelijkse afsluiting.",
        custom_text: "{{text}}",
        fallback_project: "project",
      ...
      annual_budget: {
        ...
        export: {
          ...
          section_department_budgets: "AFDELINGSBUDGETTEN",
          section_budget_distribution: "BUDGETVERDELING",
          section_department_spending: "AFDELING UITGAVEN",
          institution: "Instelling",
          year: "Jaar",
          total_budget: "Totaal Budget",
          total_allocated: "Totaal Toegewezen",
          ...
          completed: "Voltooid",
          missing: "Ontbreekt",
          success: "Jaarlijks budget succesvol geëxporteerd",
          error: "Kon begrotingsgegevens niet exporteren"
        },
        year_filter: {
  ...
  pt: {
    translation: {  
      ...
      notifications: {
        status_change_title: "Atualização em {{projectTitle}}",
        status_change_message: "{{actor}} alterou o status para \"{{status}}\"",
        subsidy_status_change_title: "Atualização de subsídio em {{projectTitle}}",
        subsidy_status_change_message: "O subsídio \"{{subsidy}}\" mudou para \"{{status}}\"",
        new_message_title: "Nova mensagem em {{projectTitle}}",
        new_message: "{{actor}}: {{comment}}",
        budget_updated_title: "Orçamento atualizado em {{projectTitle}}",
        budget_updated_message: "{{actor}} atualizou o orçamento do projeto",
        deadline_updated_title: "Prazo atualizado em {{projectTitle}}",
        deadline_updated_message: "{{actor}} atualizou o prazo do projeto",
        owner_changed_title: "Proprietário alterado em {{projectTitle}}",
        owner_changed_message: "{{actor}} atualizou o proprietário do projeto",
        co_owner_updated_title: "Co-proprietário atualizado em {{projectTitle}}",
        co_owner_updated_message: "{{actor}} atualizou o co-proprietário do projeto",
        adjustment_needed_title: "Ajuste necessário em {{projectTitle}}",
        adjustment_needed_message: "{{actor}} solicitou um ajuste",
        project_created_title: "Projeto criado",
        project_created_message: "{{actor}} criou o projeto \"{{projectTitle}}\"",
        project_deleted_title: "Projeto excluído",
        project_deleted_message: "{{actor}} excluiu o projeto \"{{projectTitle}}\"",
        activity_created_title: "Nova atividade em {{projectTitle}}",
        activity_created_message: "{{actor}} criou a atividade \"{{activityName}}\"",
        activity_updated_title: "Atividade atualizada em {{projectTitle}}",
        activity_updated_message: "{{actor}} atualizou uma atividade",
        activity_deleted_title: "Atividade removida em {{projectTitle}}",
        activity_deleted_message: "{{actor}} excluiu uma atividade",
        activity_deleted_named_message: "{{actor}} excluiu a atividade: \"{{activityName}}\"",
        subsidy_created_title: "Novo subsídio em {{projectTitle}}",
        subsidy_created_message: "{{actor}} enviou uma solicitação de subsídio",
        subsidy_created_named_message: "{{actor}} enviou uma solicitação de subsídio: \"{{subsidy}}\"",
        subsidy_updated_title: "Subsídio atualizado em {{projectTitle}}",
        subsidy_updated_message: "{{actor}} atualizou uma solicitação de subsídio",
        subsidy_approved_title: "Subsídio aprovado em {{projectTitle}}",
        subsidy_approved_message: "Uma solicitação de subsídio foi aprovada",
        subsidy_rejected_title: "Subsídio rejeitado em {{projectTitle}}",
        subsidy_rejected_message: "Uma solicitação de subsídio foi rejeitada",
        subsidy_deleted_title: "Subsídio removido em {{projectTitle}}",
        subsidy_deleted_message: "{{actor}} excluiu uma solicitação de subsídio",
        subsidy_document_updated_title: "Novo documento em {{projectTitle}}",
        subsidy_document_updated_message: "{{actor}} enviou um documento para o subsídio",
        subsidy_document_validated_title: "Documento validado em {{projectTitle}}",
        subsidy_document_validated_message: "Um documento foi validado pelo financeiro",
        subsidy_document_rejected_title: "Documento rejeitado em {{projectTitle}}",
        subsidy_document_rejected_message: "Um documento foi rejeitado pelo financeiro",
        annual_budget_created_title: "Novo Orçamento Anual",
        annual_budget_created_message: "Um novo orçamento anual foi criado para a sua entidade",
        annual_budget_closed_title: "Orçamento Anual Fechado",
        annual_budget_closed_message: "Um orçamento anual da sua entidade foi fechado",
        subsidy_deleted_named_message: "{{actor}} excluiu a solicitação de subsídio: \"{{subsidy}}\"",
        update_title: "Atualização em {{projectTitle}}",
        update_message: "{{actor}} fez uma alteração no projeto",
        assignment_request_received_title: "Novo pedido de pregação em {{churchName}}",
        assignment_request_received_message: "{{preacherName}} solicitou pregar em {{churchName}}.",
        assignment_invite_received_title: "Você foi convidado a pregar",
        assignment_invite_received_message: "Você foi convidado a pregar em {{churchName}} no dia {{date}}.",
        assignment_invite_custom_title: "Você foi convidado a pregar",
        assignment_request_accepted_title: "Pedido aceito",
        assignment_request_accepted_message: "Seu pedido de atribuição para {{churchName}} no dia {{date}} foi aceito.",
        assignment_request_declined_title: "Pedido rejeitado",
        assignment_request_declined_message: "Seu pedido de atribuição para {{churchName}} no dia {{date}} foi rejeitado.",
        monthly_close_reminder_open_slots_title: "Vagas em aberto antes do fechamento mensal",
        monthly_close_reminder_open_slots_message: "{{churchName}} ainda tem {{count}} vaga(s) em aberto para {{month}} antes de o cronograma ser bloqueado.",
        monthly_close_reminder_incomplete_availability_title: "Disponibilidade não definida para {{month}}",
        monthly_close_reminder_incomplete_availability_message: "Defina sua disponibilidade para {{month}} antes de o cronograma ser bloqueado.",
        monthly_close_auto_confirmed_title: "Atribuição confirmada automaticamente",
        monthly_close_auto_confirmed_message: "Sua atribuição pendente em {{churchName}} no dia {{date}} foi confirmada automaticamente no fechamento mensal.",
        custom_text: "{{text}}",
        fallback_project: "projeto",
        fallback_actor: "Alguém"
      },
      privacy: {
      ...
      activities: {
        ...
        user_selector: {
          ...
          selection_count: "{{selected}} de {{max}} usuário(s) selecionado(s)",
          cancel: "Cancelar",
          confirm: "Confirmar ({{count}})",
          minimum_required: "Pelo menos um responsável deve ser selecionado"
        },
        documents: {
      ...
      annual_budget: {
        ...
        export: {
          ...
          section_department_budgets: "ORÇAMENTOS POR DEPARTAMENTO",
          section_budget_distribution: "DISTRIBUIÇÃO DO ORÇAMENTO",
          section_department_spending: "GASTOS POR DEPARTAMENTO",
          ...
          balance_status: "Status do Saldo",
          lock_status: "Status do Bloqueio",
          budget_status: "Status do Orçamento",
          total: "Total",
          spent: "Gasto",
          allocated: "Alocado",
          available: "Disponível",
          percentage_used: "% Utilizado",
          reserved: "Reservado",
          locked: "Bloqueado",
          unlocked: "Desbloqueado",
          completed: "Completo",
          missing: "Ausente",
          success: "Orçamento anual exportado com sucesso",
          error: "Falha ao exportar dados do orçamento"
        },
        year_filter: {
