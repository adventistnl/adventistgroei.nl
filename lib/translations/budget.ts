  ...
  nl: {
    ...
    history: {
      ...
      table: {
        ...
        balance: "Saldo Na",
        created_by: "E-mail",
        created_by_name: "Gemaakt Door",
        related_project: "Project",
        related_subsidy: "Subsidie",
        related_destination: "Bestemming",
        related_origin: "Herkomst",
      },
  ...
  pt: {
    ...
    history: {
      ...
      table: {
        ...
        related_project: "Projeto",
        related_subsidy: "Subsídio",
        related_destination: "Destino",
        related_origin: "Origem",
      },
